        ...
        function Show-Free
        {
            ...
            Param()
                ...
                DynamicParam {
                    ...
                    New-DynamicParameter -Name Drive -ValidateSet $options -Position 0 -Mandatory
                }
    ...
    .EXAMPLE
        ...
        param(
            ...
            DynamicParam {
                ...
                New-DynamicParameter -Name AlwaysParam -ValidateSet @( gwmi win32_volume | %{$_.driveletter} | sort ) -DPDictionary $Dictionary
                #Add dynamic parameters to $dictionary
                if($x -eq 1) {
                    New-DynamicParameter -Name X1Param1 -ValidateSet 1,2 -mandatory -DPDictionary $Dictionary
                    New-DynamicParameter -Name X1Param2 -DPDictionary $Dictionary
                    New-DynamicParameter -Name X3Param3 -DPDictionary $Dictionary -Type DateTime
                }
                else {
                    New-DynamicParameter -Name OtherParam1 -Mandatory -DPDictionary $Dictionary
                    New-DynamicParameter -Name OtherParam2 -DPDictionary $Dictionary
                    New-DynamicParameter -Name OtherParam3 -DPDictionary $Dictionary -Type DateTime
                }
        ...
        # This example illustrates the creation of many dynamic parameters using New-DynamicParameter
